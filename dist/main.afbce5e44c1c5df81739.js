...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".stock__container {\n  width: 1000px;\n  height: 200px;\n  background: grey;\n  margin-bottom: 20px;\n  display: flex;\n}\n.stock__img {\n  width: 100px;\n  height: 100px;\n}", "",{"version":3,"sources":["webpack://./src/index.scss"],"names":[],"mappings":"AACI;EACI,aAAA;EACA,aAAA;EACA,gBAAA;EACA,mBAAA;EACA,aAAA;AAAR;AAGI;EACI,YAAA;EACA,aAAA;AADR","sourcesContent":[".stock {\r\n    &__container {\r\n        width: 1000px;\r\n        height: 200px;\r\n        background: grey;\r\n        margin-bottom: 20px;\r\n        display: flex\r\n    }\r\n\r\n    &__img {\r\n        width: 100px;\r\n        height: 100px;\r\n    }\r\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _dataset_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dataset.json */ "./src/dataset.json");
/* harmony import */ var _dataset_json__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_dataset_json__WEBPACK_IMPORTED_MODULE_2__);
...
function Title() {
    ...
    title.innerHTML = JSON.stringify((_dataset_json__WEBPACK_IMPORTED_MODULE_2___default().page_meta.h1));
...
function navGetItem() {
    for (let i = 0; i < (_dataset_json__WEBPACK_IMPORTED_MODULE_2___default().nav.length); i++) {
        let item = document.createElement('li');
        item.className = 'nav__item'
        item.setAttribute('href', JSON.stringify((_dataset_json__WEBPACK_IMPORTED_MODULE_2___default().nav)[i].href))
        item.innerHTML = JSON.stringify((_dataset_json__WEBPACK_IMPORTED_MODULE_2___default().nav)[i].text)
        navList.append(item)
    }
}
...
function breadcrumbsGetItem() {
    for (let i = 0; i < (_dataset_json__WEBPACK_IMPORTED_MODULE_2___default().breadcrumbs.length); i++) {
        let item = document.createElement('li');
        item.className = 'breadcrumbs__item';
        item.setAttribute('href', JSON.stringify((_dataset_json__WEBPACK_IMPORTED_MODULE_2___default().breadcrumbs)[i].href));
        item.innerHTML = JSON.stringify((_dataset_json__WEBPACK_IMPORTED_MODULE_2___default().breadcrumbs)[i].text);
...
function stockGetItem() {
    let data = (_dataset_json__WEBPACK_IMPORTED_MODULE_2___default().stock);
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        img.setAttribute('src', './img/' + (JSON.stringify(data[i].image)).replace(/\"/g, ""));
...
/******/ })()
;
//# sourceMappingURL=main.afbce5e44c1c5df81739.js.map